...
namespace EducationManagement.BLL.Services
{
    ...
    public class EmailService
    {
        ...
        public bool IsConfigured => !string.IsNullOrWhiteSpace(_smtpUsername) && !string.IsNullOrWhiteSpace(_smtpPassword);
        ...
        private void EnsureConfigured()
        {
            if (!IsConfigured)
            {
                throw new InvalidOperationException("Email chưa được cấu hình. Vui lòng cập nhật SMTP trong appsettings.");
            }
        }
